...
public:
    ...
    void setupUi(QDialog *FindSuccessDlg)
    {
        ...
        sizePolicy.setHeightForWidth(FindSuccessDlg->sizePolicy().hasHeightForWidth());
        FindSuccessDlg->setSizePolicy(sizePolicy);
        FindSuccessDlg->setMinimumSize(QSize(0, 0));
        ...
        sizePolicy.setHeightForWidth(head_lb->sizePolicy().hasHeightForWidth());
        head_lb->setSizePolicy(sizePolicy);
